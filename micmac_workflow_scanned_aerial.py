...
## STAGES
parser.add_argument('-fid', "-FIDUCIALS",dest='fid', type=int, default=1, help='DO SETUP ?:  Fiducials ## Resampling to Scan Resolution, default = 1 / else 0')
...
parser.add_argument('-tp', "-TIEPOINTS",dest='tp', type=int, default=1, help='DO SETUP ?:  Camera Positions ## Tie Points ## Tie Point Improvement, default = 1 / else 0')
parser.add_argument('-o', "-ORI",dest='ori', type=int, default=1, help='DO SETUP ?:  INTERIOR ORIENTATION ## EXTERIOR ORIENTATION, default = 1 / else 0')
...
parser.add_argument('-d_m', "-DENSE_M",dest='d_m', type=int, default=1, help='DO SETUP ?:  Orthophoto ## Dense Matching, default = 1 / else 0')
parser.add_argument('-out', "-OUTPUT",dest='out', type=int, default=1, help='DO SETUP ?:  OUTPUT, default = 1 / else 0')
